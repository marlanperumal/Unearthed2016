...
for file in os.listdir(DIR):
    if file.endswith(".png"):
        ...
        view = viewer.viewerClass(image, labelledFeat, colorData, sizeData, procTime, featTime, truth_features)
        view.view(selectSize=True, sizeValue=200)


image = skimage.io.imread("Data/Unearthed Cape Town/De Beers Particle Size Challenge/Originals/original3.png")
truth = skimage.io.imread("Data/Unearthed Cape Town/De Beers Particle Size Challenge/Truth/truth3.png")
